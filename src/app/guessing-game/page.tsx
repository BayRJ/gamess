...
export default function GuessingGame() {
  ...
  return (
    ...
    >
      ...
      <div className="wrapper w-[1000px] h-[520px] bg-white rounded-xl ">
        <div className="flex items-center justify-between">
          <h1 className="text-4xl font-medium py-5 px-6">Guess the Word</h1>
        ...
        <div className="content">
          ...
          />
          <div className="inputs flex  flex-wrap justify-center mt-12">
